...
scPagwas_topgenes <- names(Pagwas$GeneticExpressionIndex[order(Pagwas$GeneticExpressionIndex, decreasing = T), ])[1:1000]
...
- Random_Correct_BG_pdf : Dataframe containing the calculated results of p-values after background correction for each cell, including pooled_p, adj_p, pooled_z, and other results.
