...
- Single_data$scPagwas.dTRS.Score1: Trait relevant score based on anti-relevant genes. 
  ...
  Note: Although our article primarily focuses on the TRS scores, it does not imply that reverse dTRS are always devoid of significance. During our next research, we observed that in certain phenotypes, such as some cancer traits, when **the gPas score**, i.e., the sum of regression beta coefficients, **skews to the left, the dTRS becomes notably more meaningful**. However, we cannot ascertain whether this holds true for all data, nor can we pinpoint the specific reasons behind it. One possible reason for the overall leftward skewness in the distribution of "gPas" values could indicate a greater prevalence of negative associations between genotypes and phenotypes. In other words, specific genotypes may be more closely related to a reduced risk of the phenotype. However, It  requires a case-by-case analysis. The question then arises: do GWAS genetic effect mainly have a positive or negative impact on phenotypes? What factors determine this impact? This is a highly intriguing question that we intend to explore further in subsequent research. We encourage researchers to consider the skewness in the distribution of scPagwas.gPAS.score as an adjunctive factor for assessing directionality, though it is not absolute and should be analyzed on a case-by-case basis.
