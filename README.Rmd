...
system.time(
 ...
 Pagwas_data<-scPagwas_main(Pagwas = NULL,
                     gwas_data =gwas_data,#system.file("extdata", "GWAS_summ_example.txt", package = "scPagwas"), # The GWAS Summary statistics files 
...
Note: 
In terms of settings, your computer at least can handle 10,000 cells for memory need. Otherwise, an error of "cannot allocate vector of size ..." may occur.
