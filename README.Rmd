...
```{r bar_positie_nagtive,message=FALSE,fig.height=6, fig.width=6}
...
```{r bar_positie_nagtive2,message=FALSE}
plot_bar_positie_nagtive(seurat_obj=scRNAexample,
                              var_ident="anno",
...
```{r vln_Corgenes,message=FALSE,fig.height=6, fig.width=8}
